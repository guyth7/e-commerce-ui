...
const CartPage = () => {
  ...
  return (
    <section className="flex flex-col gap-8 items-center justify-center mt-12">
      {/* TITLE */}
            ...
            cart.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-full text-red-400 hover:bg-red-200 transition-all duration-300 bg-red-100 flex items-center justify-center cursor-pointer"
                >
